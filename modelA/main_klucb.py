...
if __name__ == '__main__':
    ...
    Maxitr = 20#iteration number 
   
    '''
    Statistical parameters
    '''
    
    horizon = 5000 # time horizon
    ...
    itrs = [[KLUCB, statparams, algoparams, int(itr), index] for itr in np.linspace(1, Maxitr, Maxitr)]
